...
var _selfAssesmentService = _interopRequireDefault(require("./self-assesment-service"));
...
function _saveResponses2() {
  _saveResponses2 = _asyncToGenerator(function* (req, res, next) {
    try {
      ...
      var insertedResponses = yield _selfAssesmentService.default.saveResponses(responsesInfo);
      res.status(200).send({
        success: true,
...
var SelfAssessmentApi = {
  saveResponses: _saveResponses
};
var _default = SelfAssessmentApi;
